...
//initial sprite
addSprite(540,514,1/25,id,0,-45,0,'https://roelyoon.github.io/Portfolio/Challenges/Challenge 8/initial.png');

//youtube
addModel(id,0,-65,0,1/30,new THREE.Vector3(0,0.03,0),function(){},function(gltf){gltf.scene.on('click',function(ev){window.open("https://youtu.be/a9YWQslez_4");});},'https://roelyoon.github.io/Portfolio/3DModels/youtube.glb');
